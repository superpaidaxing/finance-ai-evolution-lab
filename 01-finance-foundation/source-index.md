...
> 本文件用于记录 `01-finance-foundation/` 的专业来源。后续每批新增内容时，先检查本索引，避免反复引用同一材料却写出重复主题。

## 已使用来源

| 来源编号 | 来源名称 | 机构 | 主要覆盖内容 | 已用于哪些主题 | 链接 |
| --- | --- | --- | --- | --- | --- |
| FS-001 | 《中华人民共和国商业银行法（修正）》 | 中国人民银行 / 全国人大常委会 | 商业银行定义、业务范围、经营原则、信贷审查、接受监管 | BF-001、BF-002、BF-003、BF-007 | https://www.pbc.gov.cn/tiaofasi/144941/144951/2817252/index.html |
| FS-002 | Core Principles for effective banking supervision（2024） | Basel Committee on Banking Supervision / BIS | 有效银行监管核心原则、审慎监管、治理、风险管理 | BF-004、BF-007 | https://www.bis.org/bcbs/publ/d573.htm |
| FS-003 | Overview of Basel III and related post-crisis reforms | BIS Financial Stability Institute | Basel III、资本质量、杠杆率、LCR、NSFR、披露 | BF-005、BF-007 | https://www.bis.org/fsi/fsisummaries/b3_rpcr.pdf |
| FS-004 | 《商业银行流动性风险管理办法》政策解读 | 中国政府网 / 原银保监会 | 流动性覆盖率、净稳定资金比例、优质流动性资产充足率、流动性匹配率 | BF-004、BF-005、BF-007 | https://www.gov.cn/zhengce/2018-05/25/content_5293767.htm |
| FS-005 | 小额支付系统介绍 | 中国人民银行 | 大额/小额支付系统、批量支付、跨行支付、清算服务 | BF-001、BF-003、BF-006 | https://www.pbc.gov.cn/goutongjiaoliu/113456/113466/113492/2890086/index.html |
| FS-006 | 《2025年度中国银行业发展报告》摘要 | 中国银行业协会 | 银行业总体运行、资产业务、负债业务、中间业务、风险防控、五篇大文章 | BF-002、BF-003、BF-005 | https://www.china-cba.net/Index/show/catid/60/id/46048.html |
| FS-007 | Analyzing Banking Risk, 4th edition | World Bank | 银行风险、治理、资产负债表、风险管理、银行分析框架 | BF-002、BF-004、BF-005 | https://documents1.worldbank.org/curated/en/403931618461962435/pdf/Analyzing-Banking-Risk-A-Framework-for-Assessing-Corporate-Governance-and-Risk-Management-Fourth-Edition.pdf |
| FS-008 | 《商业银行资本管理办法》 | 国家金融监督管理总局 / 中国政府网 | 资本充足率、一级资本充足率、核心一级资本充足率、杠杆率、最低资本要求、储备资本要求 | BF-002、BF-005、BF-007、CP-004 | https://www.gov.cn/gongbao/2024/issue_11126/202401/content_6928796.html |
| FS-009 | 2025 年二季度银行业保险业主要监管指标数据情况 | 国家金融监督管理总局 / 中国政府网 | 商业银行不良贷款率、拨备覆盖率、资本充足率、流动性覆盖率、净稳定资金比例 | BF-004、BF-005、BF-007、CP-004 | https://www.gov.cn/lianbo/bumen/202508/content_7036764.htm |
| FS-010 | 中国建设银行财务摘要 | 中国建设银行 | 上市银行资产、负债、净利息收益率、不良贷款率、拨备覆盖率、资本充足率示例 | BF-002、BF-005、CP-004 | https://www2.ccb.com/chn/home/investor/summary/cwzy/index.shtml |
...
| 主题编号 | 主题 | 已覆盖文件 | 后续写作边界 |
| --- | --- | --- | --- |
| BF-001 | 商业银行定义、功能和经营原则 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md` | 不再重复“商业银行是什么”，只在具体业务中引用 |
| BF-002 | 银行资产负债表与商业模式 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md` | 后续只做年报实战和专项指标拆解 |
| BF-003 | 银行业务分类 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md` | 后续按零售、公司、金融市场、同业、中间业务单独展开 |
| BF-004 | 银行风险地图 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md` | 后续按信用、市场、流动性、操作、合规、模型风险专题展开 |
| BF-005 | 银行经营指标 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md`、`banking-core-products-and-processes-01.md` | 后续只做指标公式、报表案例和同业对比 |
| BF-006 | 银行流程与数据流 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md` | 后续连接数据治理、RAG、模型治理和流程自动化 |
| BF-007 | 银行监管逻辑 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md` | 后续只展开具体监管规则和合规清单 |
| BF-008 | 银行与 AI 的接口 | `banking-business-foundation-map.md`、`banking-business-foundation-deep-dive-01.md` | 后续连接具体 AI 用例和实验设计 |
| CP-001 | 存款业务 | `banking-core-products-and-processes-01.md` | 后续展开零售存款、公司存款、存款定价和流动性 |
...
| 方向 | 建议来源类型 | 目的 |
| --- | --- | --- |
| 中国银行业监管指标 | 国家金融监督管理总局监管统计、商业银行资本管理办法、流动性风险管理办法全文 | 补充国内监管口径和指标解释 |
...
1. 一个来源可以支持多个主题，但一个主题不要重复写成多篇。
2. 后续文件如果引用本批已有来源，应优先链接到本索引，并说明新增角度。
3. 同一概念如果已在 `banking-business-foundation-map.md` 做总览，后续专题只展开流程、指标、案例和 AI 接口，不重复解释总定义。
